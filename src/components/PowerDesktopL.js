      ...
      <div className="relative -bottom-[100px]">
        <div className="relative w-full h-full my-[250px]">
          ...
          <div className="absolute right-[21px] -top-[230px] z-10">
            <Image src="/assets/powerPhoto1.webp" alt="Performance" width={200} height={200} className="w-[470px] h-[470px] " loading="lazy" />
          </div>
          {/* Photo 2 */}
          <div className="absolute right-[95px] top-[225px] z-20">
            <Image src="/assets/powerPhoto4.jpg" alt="Musicians" width={200} height={200} className="w-[650px] " loading="lazy" />
          </div>
          {/* Photo 3 */}
          <div className="absolute left-[500px] top-[550px] z-30">
            <Image src="/assets/powerPhoto3.webp" alt="Crowd" width={600} height={600} className="w-[750px]" loading="lazy" />
          </div>
