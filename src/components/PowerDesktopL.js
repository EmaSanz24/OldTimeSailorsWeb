...
export const PowerDesktopL = async ({ data }) => {
  const {
    event,
    location,
    date,
    ...
    <>
      <div className="relative -bottom-[100px]">
        <div className="relative w-full h-full my-[250px]">
          ...
          <div className="relative border border-beige p-2 w-[1200px] h-[850px] -right-[130px] -top-[310px]">
            <div className="text-left px-10">
              <h1 className="leading-none">
                <span className="text-lightRed font-titles text-[55px]">
                  old time sailors{" "}
                </span>
              ...
              <p className="text-lightRed font-txt text-[30px] mt-4">
                {location}
              </p>
            </div>
            <div className="absolute w-[450px]  top-[20px] -right-[100px] z-20">
              <div className="bg-[#e9ddc7] h-[300px] p-6 rounded-3xl">
                ...
                <div className="mt-0.5 tracking-wide">
                  ...
                  <p className="text-darkBlue text-[20px] mt-1 font-titles underline">
            ...
            <div className="space-y-6 pl-[45px]">
              <div className="flex flex-row gap-5">
                ...
                <div className="relative w-[250px] h-[100px]">
                  <Link
                    ...
                    target="_blank"
                  >
                    <h3 className="font-txt justify-center text-[45px]">
                      BUY TICKETS
                    </h3>
                  </Link>
                </div>
              ...
              <p className="text-[35px] pr-[175px] text-[#e9ddc7] font-txt leading-10">
          ...
          <div className="relative top-[100px]">
            ...
            <Link href={"/tickets/calendar-view"}>
              <p className="absolute inset-0 font-titles text-darkBlue left-[130px] top-[45px] text-[75px]">
                more gigs
              </p>
            </Link>
          </div>
          ...
          <div className="absolute -bottom-[800px]  left-[15px] z-10 ">
            <div className="flex flex-row items-center gap-3 mb-5">
              ...
              <div className="text-[#e9ddc7] text-[40px] -mb-[280px] -ml-[105px]">
