        ...
        <div className="relative w-full h-full my-[250px]">
          ...
          <div className="border border-beige p-2 relative w-[950px] -right-[95px] -top-[310px]">
            ...
            <div className="space-y-6 p-4">
              <div className="flex flex-row gap-5">
                <div className="space-y-3">
                  {[
                    ...
                    <div key={text} className="flex items-center gap-2 text-[#e9ddc7] font-txt">
              ...
              <p className="text-md text-left text-[#e9ddc7] font-txt leading-7">
          ...
          <div className="absolute -right-[0px] -bottom-[300px]">
            <Image src="/assets/shipDrawing.webp" alt="Background drawing" width={380} height={330} className="w-[380px] h-[330px] brightness-[300%] invert" loading="lazy" />
          </div>

          <div className="absolute top-[125px] left-[10px] z-30 ">
            <Image src="/assets/powerVideoBox2.svg" alt="Video frame" width={590} height={450} className="h-[450px]" priority={true} />
          </div>
