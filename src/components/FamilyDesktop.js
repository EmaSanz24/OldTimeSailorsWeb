          ...
          <div className="border-[3px] border-darkBeige p-2 relative w-[1100px] -right-[100px] -top-[310px]">
            <div className="text-left px-10">
              <h1 className="leading-none font-titles lowercase pt-2">
                <span className="text-darkBlue text-[55px]">
                  old time sailors{" "}
                </span>
              ...
              <p className="text-darkBlue font-txt text-[30px] lowercase">
                {location}
              </p>
            </div>
              ...
              <div className="flex flex-row gap-5">
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={text}
                      className="flex items-center gap-2 text-darkBlue font-txt leading-tight"
                    >
                ...
                <div className="relative w-[250px] h-[100px]">
                  <Link
                    ...
                    target="_blank"
                  >
                    <h3 className="font-txt justify-center text-[55px] uppercase">
                      buy tickets
                    </h3>
                  </Link>
                </div>
