...
const EventDescription = memo(() => (
  <p
    className="text-[12px] pb-5 text-[#e9ddc7] font-txt text-pretty"
    translate="no"
  >
...
export const PowerMobileS = async ({ data }) => {
  ...
  return (
    <>
              ...
              <div className="space-y-3">
                ...
                <div className="relative h-[18px]">
                  <Link
                    ...
                    target="_blank"
                  >
                    <h3 className="justify-center text-[12px] font-txt">
                      {" "}
                      BUY TICKETS
                    </h3>
                  </Link>
      ...
      {/* Media section */}
      <div className="w-full h-[400px] relative top-[30px] -left-2">
          ...
          <div className="absolute left-[40px] -top-[71.5px] w-1/2 z-20">
            ...
            <div className="relative">
              ...
              <Link href={"/tickets/calendar-view"}>
                <p className="absolute inset-0 font-times font-titles text-darkBlue left-[35px] top-[13px] text-[20px]">
                  more gigs
                </p>
              </Link>
            </div>
        ...
        <div className="absolute bottom-6 left-4 z-20">
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="text-beige text-[8px] flex flex-col">
              <div className="-ml-[30px] mt-[40px] leading-none tracking-widest font-txt">
