...
const EventDescription = memo(() => (
  <div className="text-[12px] pb-5 pt-10 text-darkBlue font-txt">
    ...
    <>
      <div className="relative -bottom-[68px]">
        ...
        <div className="w-full h-[auto] relative -top-5 -left-2 mb-10">
          ...
          <div className="relative h-[200px]">
            <div className="absolute left-[18px] -top-[70px] w-1/2 z-20">
              <Image
                ...
                height={172}
                quality={75}
                className="w-[172px] h-[172px] z-10 shadow-gray-500 shadow-[0px_3px_3px_rgba(0,0,0,0.3)]"
                loading="lazy"
              />
              <div className="relative" onClick={() => router.back()} role="button" tabIndex={0}>
                <Image
                  ...
                  height={50}
                  quality={75}
                  className="w-[160px] h-[50px] absolute right-[40px] -bottom-[60px] cursor-pointer"
                  loading="lazy"
                />
          ...
          {/* Title */}
          <div className="absolute -bottom-[48px] left-[20px] z-10">
            <div className="flex flex-row items-center gap-3">
              <div className="flex flex-col leading-[39px]">
                <p className="text-darkBlue text-[50px] font-titles">family</p>
                <p className="text-darkBlue text-[50px] font-titles">show</p>
              </div>
          ...
          <Image
            ...
            height={115}
            quality={75}
            className="w-[160px] h-[115px] absolute -bottom-[55px] -right-[2px] z-20 brightness-[78%] contrast-[91%] opacity-[90%]"
            loading="lazy"
          />
        </div>
      </div>
