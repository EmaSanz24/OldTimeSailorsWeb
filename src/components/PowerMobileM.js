          ...
          <div className="w-full h-[auto] relative -top-5 -left-2 mb-10">
            <div className="relative h-[200px]">
              ...
              <div className="absolute -right-[3px] -top-[20px] w-[160px] h-[130px] z-9">
                <Image src="/assets/powerPhoto2.webp" alt="Musicians" width={180} height={160} className="w-[180px] h-[160px]" loading="lazy" />
              </div>
            </div>
              ...
              <div className="absolute left-[27px] -top-[70px] w-1/2 z-20">
                ...
                <div className="relative">
                  ...
                  <Link href={"/tickets/calendar-view"}>
                    <p className="absolute inset-0 font-times font-titles text-darkBlue left-[35px] top-[18px] text-[25px]">more gigs</p>
                  </Link>
                </div>
              </div>
