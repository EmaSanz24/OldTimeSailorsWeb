...
export const PowerMobileM = async () => {
  return (
    <>
        ...
        <div className="relative w-full h-full my-[10px]">
          ...
          <div className="w-full h-[auto] relative -top-5 -left-2 mb-10">
              ...
              <div className="absolute left-[27px] -top-[70px] w-1/2 z-20">
                ...
                <div className="relative">
                  <Image
                    ...
                    loading="lazy"
                  />
                  <p className="absolute inset-0 font-times font-titles text-[#1b344a] left-[35px] top-[18px] text-[25px]">
                    more gigs
                  </p>
                </div>
              </div>
            ...
            <div className="absolute -bottom-[38px] left-[20px] z-30">
              <div className="flex flex-row items-center gap-3">
                <div className="flex flex-col leading-none">
                  <p className="text-[#d22a4e] text-[40px] font-titles ">
                    power
                  </p>
                  <p className="text-[#d22a4e] text-[40px] font-titles">show</p>
                </div>
            ...
            <Image
              ...
              width={170}
              height={150}
              className="w-[170px] h-[140px] absolute -bottom-[70px] -right-[18px] z-20"
              loading="lazy"
            />
          </div>
        </div>
