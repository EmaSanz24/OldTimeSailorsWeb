    ...
    <>
      <div className="relative -bottom-[100px]">
        <div className="relative w-full h-full my-[250px]">
          ...
          <div className="border border-beige p-2 relative w-[850px] -right-[104px] -top-[310px]">
            ...
            <div className="space-y-6 p-4 px-10">
              <div className="flex flex-row gap-5">
                ...
                <div className="relative w-[250px] h-[100px]">
                  <Link
                    ...
                    target="_blank"
                  >
                    <h3 className="font-txt justify-center text-[35px]">
                      BUY TICKETS
                    </h3>
                  </Link>
                </div>
              ...
              <p className="text-lg text-left text-[#e9ddc7] font-txt leading-7">
          ...
          <div className="absolute -right-[30px] -bottom-[300px]">
            <Image
          ...
          <div className="relative -top-[150px]">
            ...
            <Link href={"/tickets/calendar-view"}>
              <p className="absolute inset-0 font-titles text-darkBlue left-[130px] top-[136px] text-[50px]">
                more gigs
              </p>
            </Link>
          </div>
          ...
          <div className="absolute -bottom-[320px]  left-[90px] z-10 ">
            <div className="flex flex-row items-center gap-3 mb-5">
              <div className="leading-none">
                <p className="text-lightRed text-[110px] font-titles m-0 leading-none">
                  power
                </p>
                <p className="text-lightRed text-[110px] font-titles m-0  leading-none">
                  show
              ...
              <div className="text-[#e9ddc7] text-[25px] -mb-[150px] -ml-[65px] leading-none">
