      ...
      <div className="relative -bottom-[100px]">
        <div className="relative w-full h-full my-[250px]">
          ...
          <div className="absolute left-[510px] top-[300px] z-30">
            <Image src="/assets/powerPhoto3.webp" alt="Crowd" width={400} height={500} className="w-[450px] h-[450px]" loading="lazy" />
          </div>
          ...
          <div className="absolute w-full h-full top-[190px] -left-[10px] z-30 ">
            <Image src="/assets/powerVideoBox2.svg" alt="Video frame" width={300} height={300} className="w-[650px] h-[420px]" priority={true} />
          </div>
