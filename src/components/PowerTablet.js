...
export const PowerTablet = async ({ data }) => {
  ...
  return (
    <>
      <div className="relative -bottom-[120px]  px-[45px]">
        {/* Contenedor principal con borde */}
        <div className="border border-beige p-4 mx-6 relative">
          <div className="text-left">
            <h1>
              <span className="text-lightRed font-titles text-[40px]">
                old time sailors{" "}
              </span>
            ...
            <p className="text-lightRed font-txt text-[20px]">{location}</p>
            ...
            <div className="absolute w-64 top-20 -right-4">
              <div className="bg-[#e9ddc7] p-6 rounded-3xl">
                ...
                <div className="mt-0.5">
                  ...
                  <p className="text-darkBlue text-[12px] mt-1 font-titles underline">
            ...
            <div className="flex flex-row gap-5">
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={text}
                    className="flex items-center gap-2 text-[#e9ddc7] font-txt"
                  >
              ...
              <div className="relative w-[250px] h-[100px] ">
                <Link
                  ...
                  target="_blank"
                >
                  <h3 className="font-txt justify-center text-[25px]">
                    {" "}
                    BUY TICKETS
                  </h3>
                </Link>
      ...
      {/* Media section */}
      <div className="w-full h-[auto] relative -bottom-[150px] mb-[50px]">
          ...
          <div className="absolute -top-[26px] left-[10px] w-1/2 z-20">
            ...
            <div className="relative">
              ...
              <Link href={"/tickets/calendar-view"}>
                <p className="absolute inset-0 font-titles  text-darkBlue left-[70px] top-[105px] text-[45px]">
                  more gigs
                </p>
              </Link>
            </div>
        ...
        <div className="absolute -bottom-[10px]  left-[15px] z-30 ">
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="text-[#e9ddc7] text-[17px] flex flex-col">
              <div className="-ml-[45px] mt-[70px] font-txt leading-none tracking-widest">
        ...
        <Image
          ...
          width={300}
          height={300}
          className="absolute -bottom-[20px] -right-[15px] z-20 brightness-[300%] invert"
          loading="lazy"
        />
      </div>
    </>
