...
export const PowerMobileL = async () => {
  return (
    <>
              ...
              <div className="absolute left-[26px] bottom-[86px] w-1/2 z-20">
                ...
                <div className="relative">
                  <Image
                    ...
                    loading="lazy"
                  />
                  <p className="absolute inset-0 font-titles text-[#1b344a] left-[55px] top-5 text-[24px]">
                    more gigs
                  </p>
                </div>
              </div>
            ...
            <div className="absolute -bottom-[85px] left-[20px] z-30">
              <div className="flex flex-row items-center gap-3">
                <div className="flex flex-col leading-none">
                  <p className="text-[#d22a4e] text-[45px] font-titles">
                    power
                  </p>
                  <p className="text-[#d22a4e] text-[45px] font-titles">
                    show
                ...
                <div className="text-[#e9ddc7] text-[9px] flex flex-col gap-4">
                  <div className="-ml-[40px] mt-[62px] font-titles leading-none tracking-wider">
