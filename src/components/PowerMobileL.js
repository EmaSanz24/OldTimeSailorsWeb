...
const EventIcon = memo(({ Icon, text }) => (
  <div className="flex items-center gap-2 text-darkBlue">
    ...
    <span className="text-[12px] text-beige font-txt">{text}</span>
  </div>
));
    ...
    <>
              ...
              <div className="space-y-3">
                ...
                <div className="relative h-[18px] pb-8">
                  <Link
                    ...
                    target="_blank"
                  >
                    <h3 className="font-txt justify-center text-[20px]">
                      {" "}
                      BUY TICKETS
                    </h3>
                  </Link>
      ...
      <div className="w-full h-[auto] relative top-[40px] -left-2 ">
        <div className="relative h-[200px]">
          ...
          <div className="absolute -right-[10px] -top-[25px] w-[175px] h-[130px] z-9">
            <Image
              ...
              width={180}
              height={180}
              className="w-[180px] h-[180px] shadow-2xl"
              loading="lazy"
            />
          </div>
        </div>
          ...
          <div className="absolute left-[26px] bottom-[86px] w-1/2 z-20">
            ...
            <div className="relative">
              ...
              <Link href={"/tickets/calendar-view"}>
                <p className="absolute inset-0 font-titles text-darkBlue left-[50px] top-5 text-[24px]">
                  more gigs
                </p>
              </Link>
            </div>
        ...
        <div className="absolute -bottom-[85px] left-[20px] z-30">
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="text-[#e9ddc7] text-[9px] flex flex-col gap-4">
              <div className="-ml-[30px] mt-[62px] font-txt leading-none tracking-wider">
        ...
        <Image
          ...
          width={155}
          height={135}
          className="w-[180px] h-[145px] absolute -bottom-[110px] -right-[15px] z-20 brightness-[300%] invert"
          loading="lazy"
        />
      </div>
    </>
